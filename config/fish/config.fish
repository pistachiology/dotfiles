...
function gssh ; infocmp -x | ssh $argv -- tic -x -; end
...
function tmux-dot; tmux-sessionizer ~/dotfiles; end
...
# Toolbox
set -gx PATH $PATH $HOME/.toolbox/bin

# Apollo
set -gx PATH $PATH /apollo/env/envImprovement/bin
set -gx PATH $PATH /apollo/bin

set -gx PATH $PATH ~/.tmux/bin
