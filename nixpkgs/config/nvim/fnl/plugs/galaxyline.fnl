...
;; Utils
(local buffer_not_empty #(not= (vim.fn.empty (vim.fn.expand "%:t")) 1))

(local checkwidth #(let [squeeze-width (/ (vim.fn.winwidth 0) 2)]
                     (> squeeze-width 40)))

(fn run [] ; just hack for installation
  ...
  (local show-lsp?
         #(let [tbl {:dashboard true "" true :scala true}]
            (if (. tbl vim.bo.filetype) false true)))
  (local show-metals?
         #(let [tbl {:scala true :sbt true}]
            (if (. tbl vim.bo.filetype) true false)))
  (local mid {1 {:CurlyRight {:provider #left-separator
                              :condition #(or (show-lsp?) (show-metals?))
                              :highlight [nord_colors.line_bg
                                          nord_colors.statusline
                                          :bold]}}
              ...
              5 {:CurlyLeft {:provider #right-separator
                             ...
                             :highlight [nord_colors.line_bg
                                         nord_colors.statusline
                                         :bold]}}})
  (local left {1 {:FirstElement {:provider #"▊ "
                                 :highlight [nord_colors.blue
                                             nord_colors.line_bg]}}
               2 {:ViMode {:highlight [nord_colors.red
                                       nord_colors.line_bg
                                       :bold]
                           :provider (fn []
                                       ...
                                       (local mode-color
                                              {:n nord_colors.magenta
                                               :i nord_colors.green
                                               :v nord_colors.blue
                                               "\022" nord_colors.blue
                                               :V nord_colors.blue
                                               :c nord_colors.red
                                               :no nord_colors.magenta
                                               :s nord_colors.orange
                                               :S nord_colors.orange
                                               "\019" nord_colors.orange
  ...
  (local right
         {1 {:CurlyRight {:provider #left-separator
          ...
          7 {:LineColumn {:provider :LineColumn
                          :separator ""
                          :separator_highlight [nord_colors.blue
                                                nord_colors.line_bg]
          ...
          9 {:DiagnosticError {:provider :DiagnosticError
                               ...
                               :separator " "
                               :condition buffer_not_empty
                               :separator_highlight [nord_colors.bg
                                                     nord_colors.bg]
                               :highlight [nord_colors.red nord_colors.line_bg]}}
          10 {:DiagnosticWarn {:provider :DiagnosticWarn
                               ...
                               :separator_highlight [nord_colors.bg
                                                     nord_colors.bg]
                               :highlight [nord_colors.yellow
                                           nord_colors.line_bg]}}})
  (local short_line_left
         {1 {:BufferType {:provider :FileIcon
                          :separtor " "
                          :separator_highlight [nord_colors.NONE
                                                nord_colors.lbg]
  ...
  (u.assoc gl.section :mid mid :left left :right right :short_line_left
           short_line_left :short_line_right short_line_right))
