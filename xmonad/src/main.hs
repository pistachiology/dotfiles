...
--
myWorkspaces :: [String]
myWorkspaces = ["MAIN", "MUSIC", "DEV", "FILES"]
...
myKeys conf@XConfig { XMonad.modMask = modm } =
    M.fromList
      ...
      -- Toggle Polybar
          , ((modm, xK_semicolon), spawn "polybar-msg cmd toggle")
      -- Quit xmonad
          , ((modm .|. shiftMask, xK_q), io exitSuccess)
      -- Restart xmonad
          , ( (modm, xK_q)
            , spawn "xmonad --recompile; killall dunst; xmonad --restart"
            )
      ...
      --
           ...
           | (i, k) <- zip
               ...
               [xK_parenright, xK_plus, xK_bracketright, xK_exclam]
